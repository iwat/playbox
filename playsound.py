...
class PlaysoundController:
    ...
    def is_playing(self) -> bool:
        raise("is_playing() is not implemented")

    def pause(self):
        raise("pause() is not implemented")

    def resume(self):
        raise("resume() is not implemented")

    def stop(self):
        raise("stop() is not implemented")

    def is_concluded(self) -> bool:
        raise("is_concluded() is not implemented")
...
def _playsoundOSX(sound, block = True):
    ...
    if block:
        ...
        class OSXPlaysoundController(PlaysoundController):

            def __init__(self, nssound):
                self.nssound = nssound

            def is_playing(self) -> bool:
                print(f"playing: {self.nssound.isPlaying()} volume:{self.nssound.volume()} currentTime:{self.nssound.currentTime()} duration:{self.nssound.duration()}")
                return self.nssound.isPlaying()

            def pause(self):
                return self.nssound.pause()

            def resume(self):
                return self.nssound.resume()

            def stop(self):
                return self.nssound.stop()

            def is_concluded(self) -> bool:
                return self.nssound.currentTime() == 0

        return OSXPlaysoundController(nssound)
